...
||1-6|本社住所||法人の住所の全文表記（都道府県から記入開始、丁目以下は半角数字とハイフンで記入）|文字列|東京都千代田区霞が関1-1-1|
...
||3-10|住所||連絡先の住所の全文表記（都道府県から記入し、丁目以下は半角数字とハイフンで記入）|文字列|東京都千代田区霞が関1-1-1|
...
||4-6|本社住所||法人の住所の全文表記（都道府県から記入開始、丁目以下は半角数字とハイフンで記入）|文字列|東京都千代田区霞が関1-1-1|
